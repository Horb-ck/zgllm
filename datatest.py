...
KNOWLEDGE_DATA = [
    ...
    {"course_name": "产品设计", "knowledge_points": ["产品设计", "产品设计课程引入", "产品设计认知", "产品设计案例分析", "产品设计见解讨论", "项目主题引入", "项目提案", "产品设计原理", "设计产生", "设计本质", "设计发展规律", "产品概念", "产品特征", "设计事理学", "事理学案例", "设计程序与方法", "经典设计程序", "需求分析", "概念生成", "方案设计", "原型制作", "测试评估", "设计调研方法", "产品创新设计思维", "创新思维工具", "设计需求调查", "调研分析报告", "市场定位", "客户定位", "产品机会", "初步设计概念", "概念草图", "设计评估与决策方法", "产品概念评估", "产品可用性评估", "产品情感化评估", "哈里斯图表", "EVR决策表", "C-Box", "概念筛选", "批判性思维", "模块化设计课程", "设计心理学", "设计表现", "商业模式", "业务计划", "财务模型", "专利审查", "包装推广", "设计材料", "加工工艺", "设计实践与迭代", "市场调查", "调研过程记录", "设计定位", "设计方案表达", "概念迭代", "设计规格说明", "用户调研", "生命周期评估", "设计报告书", "样机验证与成果展示", "设计模型小样", "软件数据确认", "设计方案交流", "模型测试", "模型调整", "模型反馈", "模型评估", "产品样机展示"]},
    {"course_name": "信号与系统", "knowledge_points": ["信号与系统", "电子系统设计流程", "标准化设计流程", "电子系统分析", "电子系统设计", "工程设计实践", "创造性思维", "PCB设计", "Altium Designer", "PCB工具软件", "电子元件选型", "原理图设计", "项目电路设计", "PCB设计方法", "PCB布局优化", "单片机开发", "STM32", "单片机开发流程", "软件架构设计", "嵌入式软件开发", "编程能力", "案例设计", "单片机设计方法", "电路基础", "信号完整性", "放大电路", "电路设计原则", "硬件电路集成", "硬件调试", "电路设计基础", "惯性导航", "惯性导航坐标系", "惯导系统算法", "惯导系统误差分析", "惯性导航功能", "产品设计", "产品设计流程", "产品结构设计规范", "产品结构设计", "电机驱动", "步进电机驱动", "直流无刷电机驱动", "直流有刷电机驱动", "开环控制", "闭环控制", "速度控制", "位置控制", "驱动算法", "传感器", "红外传感器", "霍尔测速传感器", "编码测速传感器", "九轴传感器", "多传感器感知", "路径规划", "地图构建", "避障算法", "路径优化", "机器人路径规划", "通信功能", "蓝牙通信", "WiFi通信", "通信功能实现", "AI扩展", "AI芯片扩展", "语音识别", "图像识别", "AI功能扩展", "充电功能", "有线回充管理", "无线充电", "充电功能实现"]},
    {"course_name": "工效学", "knowledge_points": ["工效学", "工效学导论", "工效学应用案例", "工效学发展历程", "生理人因", "认知人因", "组织人因基础", "人机交互范式", "以用户为中心的设计与评估", "用户中心设计", "用户中心评估", "产品评估", "服务评估", "系统改进假设", "系统创新假设", "统计分析沟通", "用户研究方法", "人物角色法", "人类学研究", "问卷调研", "访谈法", "认知走查", "任务分析", "用户需求", "用户洞察", "可用性测试", "可用性测试流程", "用户交互绩效", "产品评估方法", "评估实验", "实验设计", "实验设计原理", "干扰变量控制", "奶茶实验", "认知负荷", "IMU", "EMG", "人体测量", "人体测量方法", "Jack建模", "人体尺寸", "人机适配", "生物力学", "生物力学分析", "人体运动", "姿势负荷", "力学约束", "人类信息处理", "信息处理模型", "感知处理", "认知处理", "反应处理", "人类绩效模型", "感知系统", "视觉感知", "色轮实验", "听觉感知", "听觉实验", "感知规律应用", "认知系统", "注意力", "注意力实验", "记忆力", "记忆力实验", "认知规律应用", "反应系统", "人体反应规律", "MHP", "GOMS", "模型族", "反应规律应用", "组织人因", "霍桑实验", "阿希实验", "电击实验", "监狱实验", "群体行为", "组织行为情境", "原型设计", "Unity开发", "低保真原型", "高保真原型", "交互原型", "产品服务原型"]},
    {"course_name": "工程原理", "knowledge_points": ["工程原理", "电子系统设计", "电子信息技术", "电子琴电路系统", "信号采集电路", "控制器", "功率放大", "电源电路", "系统设计框架", "项目式设计", "模拟电子技术", "基本元器件", "电路仿真", "电路设计流程", "基尔霍夫定律", "电源性能测试", "集成运算放大器", "电路运算", "滤波器", "执行器及其控制与驱动", "脉宽调制", "MOSFET", "JFET", "IGBT", "2N3904", "NE555", "UC3842", "低频功率放大器", "数字电子技术", "数制", "码制", "逻辑运算", "组合逻辑电路", "时序逻辑电路", "VHDL", "状态机设计", "工程实践项目", "流水灯电路", "直流稳压电源制作", "低频功率放大器制作", "脉冲信号发生器", "计数器设计", "按键读取", "分频器设计", "电子琴制作"]},
    {"course_name": "工程设计", "knowledge_points": ["工程设计", "发动机简史", "发动机历史", "斯特林发动机历史", "样机演示", "工程设计问题", "工程热力学", "热力学发展史", "热力学第一定律", "焓", "内能", "热力学第二定律", "卡诺循环", "熵方程", "工质热力过程", "可逆多变过程", "斯特林发动机设计", "关键技术分析", "热力学设计", "零部件选型", "力学校核", "方案报告", "方案优化", "设计路线图", "斯特林热力循环", "热力循环", "斯特林发动机类型", "循环热量", "循环效率", "阿尔法型斯特林发动机", "史密特等温分析", "机械原理", "传动机构", "曲柄滑块机构", "菱形传动机构", "运动学方程", "位移曲线", "速度曲线", "加速度曲线", "机构仿真", "理论力学", "静力学公理", "受力分析", "约束反力", "受力图", "汇交力系", "自锁", "刚体", "角加速度", "刚体平面运动", "基点法", "动力学", "质点动力学", "动量定理", "质心运动定理", "动量矩定理", "平面运动微分方程", "功", "动能定理", "机械能守恒", "达朗贝尔原理", "虚位移原理", "传热学", "传热学基础", "高温温度", "低温温度", "斯特林循环温度", "材料力学", "材料选择", "金属材料", "强度理论", "外力偶矩", "力矩图", "抗弯强度", "疲劳分析", "仿真与优化", "ADAMS", "ANSYS", "MATLAB", "仿真实例", "优化方法", "样机制作", "文献查阅", "先进加工方法", "发动机样机制作", "总结汇报", "发动机测试", "设计点评"]},
    {"course_name": "无人机飞控技术", "knowledge_points": ["无人机飞控", "课程概述与预备知识", "课程简介", "Linux", "CMake", "刚体变换", "李群", "李代数", "最小二乘法", "SLAM前端-惯性传感器", "SLAM简介", "IMU测量模型", "IMU运动模型", "IMU误差模型", "运动模型离散时间处理", "IMU数据仿真", "SLAM前端-视觉里程计", "特征点提取", "特征点匹配", "位姿估计", "视觉定位", "SLAM前端-雷达里程计", "激光雷达测量模型", "点云", "点云近邻问题", "2D激光雷达SLAM", "3D激光雷达SLAM", "雷达定位", "SLAM后端-传感器融合", "状态估计", "ESKF", "IMU与GNSS融合", "GINS", "IMU与雷达融合", "LIO松耦合", "IMU与视觉融合", "VIO", "优化融合", "运动规划-搜索路径", "图形搜索", "Dijkstra", "A星算法", "跳转点搜索", "JPS", "运动规划-采样路径", "概率路线图", "PRM", "快速探索随机树", "RRT", "RRT星", "运动规划-动力学路径", "状态栅格规划", "Kinodynamic RRT星", "混合动力A星", "运动动力学约束", "运动规划-轨迹生成", "微分平坦", "轨迹优化", "BIVP", "凸优化", "无约束轨迹生成", "受限轨迹生成", "动力学与控制", "四旋翼无人机动力学", "控制系统设计", "四旋翼无人机控制", "移动机器人控制", "刚体动力学", "自主导航实践", "编程项目", "无人机试飞", "仿真实践", "自主导航算法系统", "视觉自主导航", "雷达自主导航", "机器人应用创新"]},
    {"course_name": "机器人基础", "knowledge_points": ["机器人基础", "机器人导论", "机器人定义", "机器人分类", "机器人应用", "技术发展趋势", "项目制课程", "机器人机构与结构", "机构构型", "机构原理设计", "机构设计方法", "传动方式", "末端执行器", "机器人运动学与轨迹规划", "位姿描述", "齐次变换", "D-H法", "连杆参数", "串联机器人运动学", "并联机器人运动学", "动力学建模", "轨迹规划", "机器人运动控制", "嵌入式控制系统", "控制系统组成", "控制系统功能", "运动控制方式", "关节驱动", "机械臂运动控制", "移动机器人运动控制", "嵌入式控制编程", "机器人环境感知", "传感器原理", "多传感器感知", "视觉识别", "避障技术", "循迹技术", "定位导航", "机器人数据通信", "机器人编程方式", "机器人编程语言", "控制算法", "遥控技术", "信号交互", "通信协议", "数据通信", "机器人系统", "系统架构", "系统集成", "集成技术", "交互操作", "项目制实践", "机器人组装", "结构设计", "控制板", "常用函数", "编程方法", "传感器选择", "机器人调试"]},
    {"course_name": "机器人数学基础", "knowledge_points": ["机器人数学基础", "数学符号与证明技术", "抽象线性空间与线性变换", "抽象内积空间", "三类矩阵分解", "概率统计基础与卡尔曼滤波", "序列极限及函数极值", "优化方法", "编程计算工具", "数学符号及术语", "验证技术回顾", "真值表", "否定逻辑陈述", "实数的关键属性", "数域", "线性空间", "基和维度", "线性变换", "线性变换的矩阵表示", "特征值与特征向量", "范数空间", "内积空间", "施密特正交化", "投影定理", "对称与正定阵", "QR分解", "SV分解", "LU&Cholesky分解", "概率空间", "随机变量", "随机向量", "BLUE&MVE理论", "卡尔曼滤波", "赋范空间中的开闭集", "牛顿迭代算法", "序列", "柯西序列与完备性", "收缩映射定理", "紧集与函数极值的存在性", "凸集和凸函数", "表示法", "二次规划", "线性规划", "最小化$||\\cdot||_{1}$和$||\\cdot||_{\\max}$", "优化算法", "Matlab"]},
]

COURSES_LIST = [
    "定量工程设计方法", "自动控制原理", "程序设计实践", 
    "移动机器人应用与开发", "线性代数",
    "概率论与数理统计", "人类文明史", "科技发展史","软件设计","机器人动力学与控制", "无人机飞控技术", "信号与系统", 
    "工程原理", "工程设计", "工效学", 
    "机器人基础", "产品设计",
...
# # 2. 定义你更新后的“机器人基础”最新知识点数据（按顺序自动生成ID）
# UPDATED_KNOWLEDGE_POINTS = ["机器人基础", "机器人导论", "机器人定义", "机器人分类", "机器人应用", "技术发展趋势", "项目制课程", "机器人机构与结构", "机构构型", "机构原理设计", "机构设计方法", "传动方式", "末端执行器", "机器人运动学与轨迹规划", "位姿描述", "齐次变换", "D-H法", "连杆参数", "串联机器人运动学", "并联机器人运动学", "动力学建模", "轨迹规划", "机器人运动控制", "嵌入式控制系统", "控制系统组成", "控制系统功能", "运动控制方式", "关节驱动", "机械臂运动控制", "移动机器人运动控制", "嵌入式控制编程", "机器人环境感知", "传感器原理", "多传感器感知", "视觉识别", "避障技术", "循迹技术", "定位导航", "机器人数据通信", "机器人编程方式", "机器人编程语言", "控制算法", "遥控技术", "信号交互", "通信协议", "数据通信", "机器人系统", "系统架构", "系统集成", "集成技术", "交互操作", "项目制实践", "机器人组装", "结构设计", "控制板", "常用函数", "编程方法", "传感器选择", "机器人调试"]

# COURSE_TARGET = "机器人基础"

# def sync_new_knowledge_infrastructure():
#     print(f"开始同步课程 [{COURSE_TARGET}] 的最新知识点架构...")
    
#     # 3. 构造全新标准的两种知识点列表结构（带 state 与不带 state）
#     standard_knowledge_list = []      # 供 courses 表使用
#     student_initial_knowledge_list = []  # 供 students 表使用

#     for index, kp_name in enumerate(UPDATED_KNOWLEDGE_POINTS, 1):
#         standard_knowledge_list.append({
#             "knowledge_id": index,
#             "knowledge_name": kp_name
#         })
#         student_initial_knowledge_list.append({
#             "knowledge_id": index,
#             "knowledge_name": kp_name,
#             "state": "notLearned"  # 默认初始化为未掌握
#         })

#     # 4. 更新 courses 全局大表
#     course_result = db.courses.update_one(
#         {"course_name": COURSE_TARGET},
#         {"$set": {
#             "knowledge_list": standard_knowledge_list,
#             "knowledge_count": len(standard_knowledge_list)
#         }}
#     )
#     if course_result.modified_count > 0:
#         print(f"✅ 全局课程标准模板更新成功！包含 {len(standard_knowledge_list)} 个标准知识点。")
#     else:
#         print("⚠️ 全局课程标准模板无变化或未找到该课程。")

#     # 5. 更新学生选课嵌套数组
#     print("正在扫描并重构所有已选修该课的学生档案...")
    
#     student_result = db.students.update_many(
#         {
#             "enrolled_courses.course_name": COURSE_TARGET  # 过滤出选修了这门课的学生
#         },
#         {
#             # 定位到符合条件的特定课程，并完全重刷其内部知识点树
#             "$set": { "enrolled_courses.$[courseItem].knowledge_list": student_initial_knowledge_list }
#         },
#         # 🌟 核心修复点：必须显式指定关键字参数名，且在 PyMongo 4.x 中使用下划线风格
#         array_filters=[
#             { "courseItem.course_name": COURSE_TARGET }
#         ]
#     )
    
#     print(f"🎉 知识点清洗大功告成！")
#     print(f"   - 扫描到符合条件的学生记录数: {student_result.matched_count} 人")
#     print(f"   - 成功重刷知识点树的学生人数: {student_result.modified_count} 人")

# if __name__ == "__main__":
#     sync_new_knowledge_infrastructure()